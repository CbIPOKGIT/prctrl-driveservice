...
const (
	...
	DriveService_Delete_FullMethodName    = "/DriveService/Delete"
)
...
type DriveServiceClient interface {
	...
	Delete(ctx context.Context, in *FileInfo, opts ...grpc.CallOption) (*SuccessMessage, error)
}
...
func (c *driveServiceClient) Delete(ctx context.Context, in *FileInfo, opts ...grpc.CallOption) (*SuccessMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SuccessMessage)
	err := c.cc.Invoke(ctx, DriveService_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DriveServiceServer interface {
	...
	Delete(context.Context, *FileInfo) (*SuccessMessage, error)
...
func (UnimplementedDriveServiceServer) Delete(context.Context, *FileInfo) (*SuccessMessage, error) {
...
func _DriveService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DriveService_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriveServiceServer).Delete(ctx, req.(*FileInfo))
	}
	return interceptor(ctx, in, info, handler)
}
